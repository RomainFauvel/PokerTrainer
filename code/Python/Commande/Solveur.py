...
def run_script():
    path=os.getcwd()
    os.chdir(path+"\\code\\Solveur")
    subprocess.run("TexasSolverWindows\\console_solver.exe --input_file .\\TexasSolverWindows\\resources\\text\\commandline_sample_input.txt",shell=True)
    os.chdir(path)
