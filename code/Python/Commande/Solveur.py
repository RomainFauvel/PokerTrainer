...
def run_script():
    ...
    if system == "Linux":
        ...
        os.system("start cmd /c code\Solveur\resources\console_solver.bat text\commandline_sample_input.txt")
        print("windows")
    else:
