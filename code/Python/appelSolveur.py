...
main1=premierApproche.JeuDeCartes.distribuer(jeu,2)
print(premierApproche.JeuDeCartes.toStringPaire(main1))
Smain1=premierApproche.JeuDeCartes.toStringPaire(main1)
ecritureEntree()
lancerSolveur()
